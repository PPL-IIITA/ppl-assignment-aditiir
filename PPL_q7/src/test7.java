 ...
 * gifting details
 * Calls the methods of respective classes according
 * to entered choice of user 
 */
public class test7 {
 ...
 //      print(g,b);
    ...
    Arrays.sort(happy);
    int ki=4;
    String[] arr_b1=new String[30];
    BufferedReader gr2=new BufferedReader(new FileReader("name_b.txt"));
    String line2;
    int yi=0;
        while((line2=gr2.readLine())!=null&&yi!=30)
      {
          arr_b1[yi]=line2;
          yi++;
      }
        ...
        System.out.println("Enter 0 for array representation");
        System.out.println("Enter 1 for sorted array");
        System.out.println("Enter 2 for hash function");
        d=Integer.parseInt(in1.readLine());
        if(d==1)
        {
        implem2 u=new implem2();
        ...
        {
            HashSearch u=new HashSearch();
            for(int q=0;q<12;q++)
            {
                u.storeData(c[q].name_boy,c[q].name_girl);
            }
